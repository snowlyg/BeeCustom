    ...
    F.prototype.config = {
        ...
        if (i.startTime = (new Date).getTime(), a.url) {
            ...
            a.contentType && 0 == a.contentType.indexOf("application/json") && (d = JSON.stringify(d)), t.ajax({
                ...
                headers: a.headers || {},
                success: function (t) {
                    "function" == typeof a.parseData && (t = a.parseData(t) || t), i.renderData(t, e, t[n.countName]), o(), a.time = (new Date).getTime() - i.startTime + " ms", i.setColsWidth(), "function" == typeof a.done && a.done(t, e, t[n.countName])
                },
                error: function (e, t) {
        ...
        a.layTool.on("click", "*[lay-event]", function (e) {
            ...
            var i = t(this), a = document.body.style.zoom ? i.offset().left*document.body.style.zoom : i.offset().left, l = e.clientX - a;
            i.data("unresize") || s.resizeStart || (s.allowResize = (document.body.style.zoom ? i.width()*document.body.style.zoom : i.width()) - l <= 10, c.css("cursor", s.allowResize ? "col-resize" : ""))
