...
(function (g) {
    ...
    var b = function (q) {
        ...
        this.inputView = g(q);
        var flag = true;
        this.inputView.attr("autocomplete", "off").on('compositionstart', this._compositionstart = function () {
            flag = false;
        }).on('compositionend', this._compositionend = function () {
            flag = true;
        }).keyup(this._keyup = function (s) {
            switch (s.keyCode) {
                case 13:
                case 16:
                case 17:
    ...
    var n = function (q, s) {
        if (q.trim()) {
            var r = RegExp(q.trim().replace(/([.?*+^$[\]\\(){}|-])/g, "\\$1"), "i");
...
layui.define(function (exports) {
    exports('AutoComplete', layui.$.AutoComplete);
});